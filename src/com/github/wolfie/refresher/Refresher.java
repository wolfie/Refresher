...
import com.github.wolfie.refresher.client.RefresherServerRpc;
import com.github.wolfie.refresher.client.RefresherState;
...
public class Refresher extends AbstractComponent {
	...
	public void setRefreshInterval(final int intervalInMillis) {
		getState().setPollingInterval(intervalInMillis);
		requestRepaint();
	}
	...
	public int getRefreshInterval() {
		return getState().getPollingInterval();
	}
